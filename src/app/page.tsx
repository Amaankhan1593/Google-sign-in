...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-100 to-blue-200 px-4 text-gray-800">
      <motion.div 
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 text-gray-900 drop-shadow">
          Welcome to Our Form
        </h1>
       <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-xl mx-auto">
        Securely log in with Amazon Cognito, or use your Google or Microsoft account — fast, reliable, and hassle-free.
       </p>

        <Link
          href="/login"
          className="inline-block px-8 py-3 bg-blue-600 text-white text-lg rounded-2xl shadow hover:bg-blue-700 hover:shadow-lg transition duration-300"
        >
          Go to Login
        </Link>
        ...
        <div className="mt-8 text-sm text-gray-600">
          <span>Need help? </span>
          <a href="mailto:support@example.com" className="text-blue-700 hover:underline">Contact Support</a>
        </div>
      </motion.div>
    </main>
  );
